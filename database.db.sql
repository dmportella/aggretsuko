...
CREATE TABLE IF NOT EXISTS "events" ( `id` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE, `ownerId` TEXT NOT NULL, `message` TEXT NOT NULL, `created` TEXT NOT NULL, `eventTIme` TEXT );
